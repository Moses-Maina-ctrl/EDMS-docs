...
**IDMS** is a _community-supported_ open-source document management system that transforms your
...
IDMS aims to be as nice to use as it is useful. Check out some screenshots below.
...
Of course, IDMS also supports dark mode:
...
IDMS is available in many languages that are coordinated on [Crowdin](https://crowdin.com/project/paperless-ngx). If you want to help out by translating paperless-ngx into your language, please head over to the [IDMS project at Crowdin](https://crowdin.com/project/paperless-ngx), and thank you!
